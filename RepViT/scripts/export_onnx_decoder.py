...
parser.add_argument(
    ...
    type=str,
    required=True,
    help="In ['default', 'repvit', 'vit_h', 'vit_l', 'vit_b']. Which type of SAM model to export.",
)
...
def run_export(
    ...
    dummy_inputs = {
        ...
        "point_coords": torch.randint(low=0, high=resolution, size=(1, 5, 2), dtype=torch.float),
    ...
    output = f"onnx/{args.model}_decoder_{resolution}.onnx"
